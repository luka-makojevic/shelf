...
public class RegistrationTest extends BaseTest {
    ...
    public void pageSetUp() throws IOException {
            navigateToPageUrl("registrationPageUrl");
    }
