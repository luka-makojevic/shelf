...
class FileServiceTest {
    ...
    void updateDeletedFilesTrue() {
        ...
        when(fileRepository.findAllByUserIdAndDeletedAndIdIn(user.getId(), fileIds)).thenReturn(fileEntities);
        ...
        verify(fileRepository, times(1)).findAllByUserIdAndDeletedAndIdIn(user.getId(), fileIds);
